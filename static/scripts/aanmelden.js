...
function valid(step) {
    ...
    if (step === 6)  {
        ...
        const type1 = isEmpty($("input[name='Racefiets']").val());
        const type2 = isEmpty($("input[name='Elektrische bakfiets']").val());
        const type3 = isEmpty($("input[name='Stint']").val());
